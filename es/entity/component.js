...
import { move, setCustom, linkTo, addLinkedEntity, removeEntity, selectEntity } from './reducer';
  ...
  return function (_React$PureComponent) {
    ...
    function _class2(props) {
      ...
      _this.onDoubleClick = function (ev) {
        ...
        React.createElement(FormDialog, { isOpen: _this.state.isOpen });
      };
    ...
    _class2.prototype.render = function render() {
      return React.createElement(
        ...
        React.createElement(FormDialog, { isOpen: this.state.isOpen, testFunc: this.testFunc, statechange: this.stateChange })
      );
    };

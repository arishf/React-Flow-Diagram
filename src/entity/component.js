...
type EntityContainerProps = {
  ...
  setCustom: SetCustomPayload => EntityAction,
...
const EntityContainerHOC = WrappedComponent =>
  class extends React.PureComponent<
    ...
    // onDoubleClick = (ev: SyntheticMouseEvent<HTMLElement>) => {
      ...
      render() {
        return (
          <div>
            ...
            <FormDialog isOpen={this.state.isOpen} testFunc={this.testFunc} statechange = {this.stateChange}/>
          </div>
        );
      }
